 ...
 * @param {string} [options.baseDir=process.env.BASE_FOLDER] - The base directory (default is `process.env.BASE_FOLDER`).
...
export const pathResolver = ({ baseDir = process.env.BASE_FOLDER, path }) => {
  return `/${baseDir}/${path}`;
};
